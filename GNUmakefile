...
PROVIDER_DIR?=$(TERRAFORM_D)/plugins/registry.terraform.io/grigoriy0/mysql/$(subst v,,$(VERSION))/$(GOOS)_$(GOARCH)
PROVIDER_DIR_DEV?=$(TERRAFORM_D)/plugins/registry.terraform.io/grigoriy0/mysql/$(subst v,,$(VERSION))-dev/$(GOOS)_$(GOARCH)
